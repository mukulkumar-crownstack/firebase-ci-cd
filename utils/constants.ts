...
export const es = {
    ...
    "Thank you for applying with Partrunner. Your application ID is :applicationID .\n\nIf you want to continue or make changes, click here": "Gracias por aplicar con PartRunner. Su ID de aplicación es YYYYY.  Si desea continuar o hacer cambios, ingrese aquí:",
...
export const driverAvailabiltyData = [
  {
